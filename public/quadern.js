...
var competenciesByArea = {
  llengues: [
    comp('lleng-ce1','Diversitat lingüística i cultural','DL','sky',[
      crit('Valora la diversitat lingüística i cultural.','Mostra poc interès per la diversitat lingüística i cultural.','Reconeix i valora la diversitat lingüística i cultural en situacions habituals.','Mostra interès i una actitud positiva envers diferents llengües i cultures.','Valora activament la diversitat lingüística i cultural i en destaca la riquesa.'),
      crit('Respecta altres llengües i cultures.','Mostra dificultats per respectar altres llengües i cultures.','Respecta altres llengües i cultures en situacions quotidianes.','Mostra una actitud oberta i respectuosa envers altres llengües i cultures.','Promou activament el respecte i la convivència entre diferents llengües i cultures.')
    ]),
    comp('lleng-ce2','Comprensió oral','CO','clay',[
      crit('Comprèn missatges orals senzills.','Té moltes dificultats per comprendre missatges orals senzills.','Comprèn missatges orals senzills amb alguna ajuda.','Comprèn adequadament missatges orals senzills de manera autònoma.','Comprèn amb facilitat missatges orals diversos, fins i tot quan presenten alguna dificultat.'),
      crit('Identifica la informació principal.','Té dificultats per identificar la informació principal.','Identifica la informació principal amb ajuda ocasional.','Identifica correctament la informació principal i alguns detalls.','Identifica amb autonomia la informació principal i els detalls rellevants.')
    ]),
    comp('lleng-ce3','Expressió i interacció oral','EI','plum',[
      crit('S\'expressa oralment de manera comprensible.','Té dificultats per expressar-se de manera comprensible.','S\'expressa de manera comprensible en situacions senzilles.','S\'expressa amb claredat i adequació en diferents situacions.','S\'expressa amb fluïdesa, precisió i naturalitat.'),
      crit('Participa en interaccions senzilles.','Participa poc o necessita molta ajuda per interactuar.','Participa en interaccions senzilles amb suport.','Participa activament i adequadament en interaccions senzilles.','Participa amb iniciativa, fluïdesa i respecte, adaptant-se a diferents situacions comunicatives.')
    ]),
    comp('lleng-ce4','Comprensió escrita','CE','moss',[
      crit('Comprèn textos escrits senzills.','Té moltes dificultats per comprendre textos escrits senzills.','Comprèn textos senzills amb alguna ajuda.','Comprèn adequadament textos escrits adequats al nivell.','Comprèn amb autonomia textos diversos i n\'interpreta el significat amb precisió.'),
      crit('Identifica la informació principal.','Té dificultats per localitzar la informació principal.','Identifica la informació principal amb ajuda.','Identifica correctament la informació principal i alguns detalls.','Identifica amb autonomia les idees principals i els detalls més rellevants.')
    ]),
    comp('lleng-ce5','Producció escrita','PE','honey',[
      crit('Escriu textos senzills i adequats.','Té dificultats per produir textos senzills i adequats.','Escriu textos senzills i comprensibles amb alguna ajuda.','Escriu textos clars, coherents i adequats a la situació comunicativa.','Escriu textos ben estructurats, coherents, precisos i adequats al destinatari i la situació.'),
  ...
  castellaLleng: [
    comp('cast-ce1','Diversidad lingüística y cultural','DL','sky',[
      crit('Valora la diversidad lingüística y cultural.','Muestra poco interés por la diversidad lingüística y cultural.','Reconoce y valora la diversidad lingüística y cultural en situaciones habituales.','Muestra interés y una actitud positiva hacia diferentes lenguas y culturas.','Valora activamente la diversidad lingüística y cultural y destaca su riqueza.'),
      crit('Respeta otras lenguas y culturas.','Muestra dificultades para respetar otras lenguas y culturas.','Respeta otras lenguas y culturas en situaciones cotidianas.','Muestra una actitud abierta y respetuosa hacia otras lenguas y culturas.','Promueve activamente el respeto y la convivencia entre diferentes lenguas y culturas.')
    ]),
    comp('cast-ce2','Comprensión oral','CO','clay',[
      crit('Comprende mensajes orales sencillos.','Tiene muchas dificultades para comprender mensajes orales sencillos.','Comprende mensajes orales sencillos con alguna ayuda.','Comprende adecuadamente mensajes orales sencillos de manera autónoma.','Comprende con facilidad mensajes orales diversos, incluso cuando presentan alguna dificultad.'),
      crit('Identifica la información principal.','Tiene dificultades para identificar la información principal.','Identifica la información principal con ayuda ocasional.','Identifica correctamente la información principal y algunos detalles.','Identifica con autonomía la información principal y los detalles relevantes.')
    ]),
    comp('cast-ce3','Expresión e interacción oral','EI','plum',[
      crit('Se expresa oralmente de manera comprensible.','Tiene dificultades para expresarse de manera comprensible.','Se expresa de manera comprensible en situaciones sencillas.','Se expresa con claridad y adecuación en diferentes situaciones.','Se expresa con fluidez, precisión y naturalidad.'),
      crit('Participa en interacciones sencillas.','Participa poco o necesita mucha ayuda para interactuar.','Participa en interacciones sencillas con apoyo.','Participa activamente y adecuadamente en interacciones sencillas.','Participa con iniciativa, fluidez y respeto, adaptándose a diferentes situaciones comunicativas.')
    ]),
    comp('cast-ce4','Comprensión escrita','CE','moss',[
      crit('Comprende textos escritos sencillos.','Tiene muchas dificultades para comprender textos escritos sencillos.','Comprende textos sencillos con alguna ayuda.','Comprende adecuadamente textos escritos adecuados al nivel.','Comprende con autonomía textos diversos e interpreta su significado con precisión.'),
      crit('Identifica la información principal.','Tiene dificultades para localizar la información principal.','Identifica la información principal con ayuda.','Identifica correctamente la información principal y algunos detalles.','Identifica con autonomía las ideas principales y los detalles más relevantes.')
    ]),
    comp('cast-ce5','Producción escrita','PE','honey',[
      crit('Escribe textos sencillos y adecuados.','Tiene dificultades para producir textos sencillos y adecuados.','Escribe textos sencillos y comprensibles con alguna ayuda.','Escribe textos claros, coherentes y adecuados a la situación comunicativa.','Escribe textos bien estructurados, coherentes, precisos y adecuados al destinatario y la situación.'),
      crit('Revisa y mejora sus producciones.','No revisa sus producciones o necesita mucha ayuda.','Revisa los textos con ayuda y corrige algunos errores.','Revisa y mejora sus producciones de manera autónoma.','Revisa críticamente sus producciones e introduce mejoras de manera sistemática y autónoma.')
    ]),
    comp('cast-ce6','Búsqueda y tratamiento de la información','BT','sky',[
      crit('Busca y selecciona información.','Tiene dificultades para buscar y seleccionar información adecuada.','Busca y selecciona información básica con ayuda.','Busca y selecciona información relevante de manera adecuada.','Busca, selecciona y contrasta información de manera autónoma y crítica.'),
      crit('Organiza y comunica la información.','Tiene dificultades para organizar y comunicar la información.','Organiza y comunica información básica con ayuda.','Organiza la información de manera clara y la comunica adecuadamente.','Organiza la información de manera eficiente y la comunica con claridad, precisión y autonomía.')
    ]),
    comp('cast-ce7','Lectura','LE','clay',[
      crit('Comprende textos adecuados al nivel.','Tiene dificultades para comprender textos adecuados a su nivel.','Comprende textos sencillos con alguna ayuda.','Comprende adecuadamente los textos trabajados.','Comprende textos diversos con profundidad y autonomía.'),
      crit('Muestra interés por la lectura.','Muestra poco interés por la lectura.','Muestra interés ocasional por la lectura.','Muestra interés habitual y una actitud positiva hacia la lectura.','Muestra un interés constante y disfruta de la lectura de manera autónoma.')
    ]),
    comp('cast-ce8','Mediación','ME','plum',[
      crit('Facilita la comprensión entre lenguas.','Tiene dificultades para facilitar la comprensión entre lenguas.','Facilita la comprensión de mensajes sencillos con ayuda.','Facilita adecuadamente la comprensión de mensajes sencillos entre lenguas.','Facilita la comprensión de manera autónoma, clara y adaptada a las necesidades del interlocutor.'),
      crit('Transmite información básica.','Tiene dificultades para transmitir información básica.','Transmite información básica con apoyo.','Transmite información básica de manera clara y adecuada.','Transmite información de manera precisa, clara y adaptada al contexto y al destinatario.')
    ]),
    comp('cast-ce9','Reflexión sobre la lengua','RL','moss',[
      crit('Reflexiona sobre el funcionamiento de la lengua.','Tiene dificultades para identificar y reflexionar sobre aspectos básicos de la lengua.','Identifica algunos aspectos del funcionamiento de la lengua con ayuda.','Reflexiona adecuadamente sobre aspectos del funcionamiento de la lengua.','Reflexiona de manera autónoma y crítica sobre el funcionamiento de la lengua y establece relaciones entre diferentes aspectos.'),
      crit('Utiliza estrategias para mejorar el aprendizaje.','Tiene dificultades para utilizar estrategias de aprendizaje.','Utiliza algunas estrategias con ayuda.','Utiliza estrategias adecuadas para mejorar su aprendizaje.','Selecciona y aplica de manera autónoma estrategias eficaces para mejorar su aprendizaje.')
    ]),
    comp('cast-ce10','Uso ético del lenguaje','UE','honey',[
