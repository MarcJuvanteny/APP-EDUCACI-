...
const ESTRUCTURA_TRIMESTRAL = `TASCA: informe trimestral.
...
const ESTRUCTURA_CURS = `TASCA: informe final de curs. Rebràs notes i comentaris del 1r, 2n i 3r trimestre per separat.
...
function systemPromptAlumne(etapa) {
  const estructura = etapa === "curs" ? ESTRUCTURA_CURS : ESTRUCTURA_TRIMESTRAL;
  return `${BASE}
